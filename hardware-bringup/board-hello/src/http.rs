...
pub fn send_heartbeat(modem: &mut Modem, delay: &Delay, payload: &heapless::String<256>) {
    ...
    modem.send_command_and_print_response(data_command.as_bytes(), "AT+HTTPDATA HEARTBEAT", delay);
    ...
    println!("Heartbeat JSON sent to modem.");
